...
import {Typography,Divider,Badge,Dialog,IconButton,FormControlLabel,Grid,Switch,Popover,Paper,Box,TextField,Avatar,ButtonBase,InputAdornment,ButtonGroup,Button,Tooltip, TableContainer} from '@material-ui/core';
                ...
                switch(selectedBtn){
                    ...
                    return(
                        ...
                        {shiftInfo.map(shift =>{
                            return (
                                ...
                                <ShiftDayBox selectedDate={selectedDate}  shift={shift} handlePopUp={handlePopUp} setClickSchedule={setClickSchedule} mode={mode}/>    
                            )
                        })}
                        <FormControlLabel control={<Switch checked={mode} onChange={handleChangeMode} />} className={classes.mode} />
                        </> )
                    case 1: //WEEK VIEW
                        return(
                            <>
                    ...
                    case 2:
                        return(
                            ...
                            <FormControlLabel control={<Switch checked={modeMonth} onChange={handleChangeModeMonth} />} className={classes.mode} />
...
const shiftInfoWeek =[
    {
        ...
        scheduleList:[
            ...
            {employeeId:3 ,name: 'Mai Truong Khang',  date:'29/11/2021', status: 0},
            {employeeId:4 ,name: 'Mai Huynh Tuan Kiet', date:'29/11/2021', status: 1},
    ...
    },
    {
        ...
        scheduleList:[
            ...
            {employeeId:1 ,name: 'Gia Le', date:'30/11/2021', status: -1},
            {employeeId:5 ,name: 'Minh Tri',  date:'30/11/2021', status: -1},
            {employeeId:1 ,employeeId:1 ,name: 'Gia Le', date:'30/11/2021', status: -1},
            {employeeId:5 ,name: 'Minh Tri',  date:'30/11/2021', status: -1},
...
const shiftInfoMonth = [
    {
        ...
        scheduleList:[
            ...
            {employeeId:4 ,name: 'Mai Huynh Tuan Kiet', date:'02/11/2021', status: 1},
