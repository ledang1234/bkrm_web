  ...
  return(
    <ReportCard  title={`Báo cáo chi tiết`}  
        ...
        <Grid container justifyContent='space-between' alignItems='center'  >
            <Grid item xs={4}><Typography style={{color:"#000",fontSize:17,fontWeight:500,}}>Nhà cung cấp</Typography></Grid>
            <Grid item xs={2}><Typography style={{ color:"#000",fontSize:17,fontWeight:500,textAlign:"center"}}>Số lần nhập</Typography></Grid>
            <Grid item xs={2}><Typography style={{color:"#000",fontSize:17,fontWeight:500,textAlign:"center"}}>Tổng tiền nhập</Typography></Grid>
        ...
        {productData?.map((item)=>{
            ...
            <Grid container justifyContent='space-between' alignItems='center' style={{marginBottom:10}} >
               <Grid item xs={4}>
                ...
                <Grid item xs={2}><Typography style={{color:"#000", fontSize:16,textAlign:"center"}}>{item.total_purchase_price ? Number(item.total_purchase_price).toLocaleString() :0}</Typography></Grid>
                <Grid item xs={2}><Typography style={{color:"#000", fontSize:16,textAlign:"center"}}>{ item.total_purchase_price ?  Number(item.total_purchase_price).toLocaleString() :0}</Typography></Grid>
