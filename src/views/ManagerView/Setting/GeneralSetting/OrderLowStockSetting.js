...
const OrderLowStockSetting = ({checked,handleClose,handleSubmit,name}) => {
  ...
  <FormControl component="fieldset">
    ...
    <FormControlLabel value="Auto" control={<Radio />} label={<Typography style={{color:"#000", fontWeight:600,fontSize:16, marginRight:15}}>1. Hệ thống gợi ý theo thời gian dự kiến hết hàng và số lượng đặt hàng lại </Typography>} />
    <ListItem>
